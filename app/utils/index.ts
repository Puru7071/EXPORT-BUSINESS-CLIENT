export const heroAchievement: { title: string, description: string }[] = [
  {
    "title": "20+ Years",
    "description": "Decades of experience in sourcing and exporting Indian products."
  },
  {
    "title": "3 Generations",
    "description": "A legacy business trusted worldwide."
  },
  {
    "title": "10,000+ Orders",
    "description": "Thousands of successful deliveries globally."
  },
  {
    "title": "100% Quality",
    "description": "Carefully sourced and quality-checked goods."
  },
  {
    "title": "3+ Countries",
    "description": "Serving clients in Nepal, Bhutan, Sri Lanka, India & expanding further."
  }
]
...
export const TypeWriterTexts = [
  ...
  "Your Gateway to World-Class Products.",
  "Connecting India to the World.",
  "Quality that Travels Across Oceans.",
  "Exporting Excellence, Importing Trust.",
  "Where Heritage Meets Global Trade.",
  "Driven by Quality, Trusted Worldwide.",
  "Excellence in Every Export.",
]
...
export const visions = [
  "At Bhargav Trading Co., we export not just products, but trust, quality, and lasting relationships — backed by three generations of experience in global trade.",
  "भार्गव ट्रेडिंग कंपनी में हम सिर्फ़ उत्पाद नहीं, बल्कि विश्वास, गुणवत्ता और लंबे रिश्ते निर्यात करते हैं — वैश्विक व्यापार में तीन पीढ़ियों के अनुभव के साथ।",
  "ভর্গব ট্রেডিং কো-তে আমরা শুধু পণ্য নয়, বিশ্বাস, গুণমান ও দীর্ঘস্থায়ী সম্পর্ক রপ্তানি করি — বিশ্বব্যাপী বাণিজ্যে তিন প্রজন্মের অভিজ্ঞতা নিয়ে।",
  "ਭਾਰਗਵ ਟ੍ਰੇਡਿੰਗ ਕੰਪਨੀ ਵਿੱਚ, ਅਸੀਂ ਸਿਰਫ਼ ਸਮਾਨ ਨਹੀਂ, ਸਗੋਂ ਭਰੋਸਾ, ਗੁਣਵੱਤਾ ਅਤੇ ਪੱਕੇ ਰਿਸ਼ਤੇ ਨਿਰਯਾਤ ਕਰਦੇ ਹਾਂ — ਵਿਸ਼ਵ ਵਪਾਰ ਦੇ ਤਿੰਨ ਪੀੜ੍ਹੀਆਂ ਦੇ ਅਨੁਭਵ ਨਾਲ।",
  "بھارگَو ٹریڈنگ کمپنی میں ہم صرف مصنوعات نہیں بلکہ اعتماد، معیار اور دیرپا تعلقات برآمد کرتے ہیں — عالمی تجارت میں تین نسلوں کے تجربے کے ساتھ۔",
  "பார்கவ் ட்ரேடிங் கம்பெனியில், நாங்கள் பொருட்களை மட்டுமல்லாமல் நம்பிக்கை, தரம் மற்றும் நீண்டகால உறவுகளை ஏற்றுமதி செய்கிறோம் — உலக வர்த்தகத்தில் மூன்று தலைமுறைகளின் அனுபவத்துடன்.",
  "భార్గవ్ ట్రేడింగ్ కంపెనీలో మేము కేవలం ఉత్పత్తులు మాత్రమే కాకుండా నమ్మకం, నాణ్యత మరియు దీర్ఘకాల సంబంధాలను ఎగుమతి చేస్తాము — గ్లోబల్ ట్రేడ్లో మూడు తరాల అనుభవంతో.",
  "ഭാർഗവ് ട്രേഡിംഗ് കമ്പനിയിൽ, ഞങ്ങൾ ഉൽപ്പന്നങ്ങൾ മാത്രമല്ല, വിശ്വാസം, ഗുണമേന്മ, ദീർഘകാല ബന്ധങ്ങളും കയറ്റുമതി ചെയ്യുന്നു — ആഗോള വ്യാപാരത്തിൽ മൂന്ന് തലമുറകളുടെ അനുഭവസമ്പത്തോടൊപ്പം.",
  "भार्गव ट्रेडिङ्ग कम्पनीमा हामी केवल वस्तु मात्र होइन, विश्वास, गुणस्तर र दिगो सम्बन्ध निर्यात गर्छौं — तीन पुस्ताको विश्वव्यापी व्यापार अनुभवसहित।",
  "භාර්ගව් වෙළඳ සමාගමෙන් අපි නිෂ්පාදන පමණක් නොව, විශ්වාසය, තත්ත්වය සහ දිරායුෂ සබඳතා අපනයනය කරමු — ලෝක වෙළඳාම තුළ පරම්පරා තුනක පළපුරුද්ද සමඟ.",
  "भार्गव ट्रेडिंग कम्पनीमे हम सभ केवल सामान नहि, भरोसा, गुणवत्ता आ टिकाउ संबंध निर्यात करैत छी — वैश्विक व्यापारमे तीन पीढ़ीके अनुभवसँ।",
  "At Bhargav Trading Co., we export not just products, but trust, quality, and lasting relationships — backed by three generations of experience in global trade.",
];
...
export const punchLines = [
  ...
  "Uncompromising Quality and Global Standards",
  "Expertise in International Trade and Logistics",
