            ...
            <div className='w-[90%] flex flex-row justify-evenly items-center'>
                <div className='text-white font-bold flex justify-start items-center gap-4'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <span className='text-sm text-zinc-400 flex flex-row gap-2'>
                            <a href={`mail:+91 ${mobile}`} className='flex flex-row items-center gap-2'> <FaPhoneAlt /> +91 {mobile} | </a>
                            <a href={`mail:+91 ${email}`} className='flex flex-row items-center gap-2'> <FaEnvelope />{email} </a>
                        </span>
                    </div>
                </div>
                ...
                <div className="my-0 text-white font-bold flex flex-col justify-between">
                    ...
                    <div className='flex flex-row gap-2 text-sm text-zinc-400'>
                        <a href={`mail:+91 ${creatorInfo.mail}`} className='flex flex-row items-center gap-2'> <FaEnvelope /> Email | </a>
